[![Build Status](https://app.travis-ci.com/vonostmann/pyneng-examples-exercises.svg?branch=master)](https://app.travis-ci.com/vonostmann/pyneng-examples-exercises)
